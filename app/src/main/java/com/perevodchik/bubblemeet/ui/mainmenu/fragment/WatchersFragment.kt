...
import com.perevodchik.bubblemeet.ui.mainmenu.presenter.WatchersPresenter

class WatchersFragment: Fragment() {
    private var adapter: GridAdapter? = null
    private var gridView: GridView? = null
    private val presenter = WatchersPresenter(this)

    companion object {
        fun newInstance() = WatchersFragment()
    }
    ...
    fun setWatchers(list: List<UserData>) {
